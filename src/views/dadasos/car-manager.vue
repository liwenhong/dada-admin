<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="姓名" min-width="200px" prop="realName" align="center">
      </el-table-column>
      <el-table-column label="电话" min-width="120px" prop="mobile" align="center">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      Bomb_Search('validUser',data,this.listQuery.limit,this.listQuery.page,this.listQuery.time).then(res => {
        console.log(res)
      ...
      this.$refs['dataForm'].validate(async (valid) => {
        if (valid) {
          ...
          await register(d).then((r) => {
            console.log('注册成功')
            let p = Bmob_CreatePoint('userInfo',r.objectId)
            this.rowInfo.user = p
